...
export const employerRequestsNew = [
  {
    ...
    status: "Urgent",
    description:
      "Looking for an experienced React developer with 5+ years of experience.",
  ...
  },
  {
    ...
    status: "New",
    description:
      "Seeking a full stack developer with experience in React and Python.",
  ...
  },
  {
    ...
    status: "Pending",
    description:
      "Looking for a frontend developer with healthcare industry experience.",
...
export const openJobEmployers = [
  ...
  },
  {
    ...
    openings: 3,
    description:
      "Looking for data scientists with machine learning experience.",
