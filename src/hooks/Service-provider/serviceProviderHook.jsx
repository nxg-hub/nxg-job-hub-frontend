...
const API_BASE_URL =
  ...
  "https://nxg-job-hub-backend.onrender.com";
...
export const useServiceProviderProfileUpdate = () => {
  ...
  const updateServiceProviderProfile = async (apiPayload) => {
    ...
    if (!authToken || !id) {
      throw new Error(
        "Authentication token or Service Provider ID not found. Please login again."
      );
    }
    ...
    try {
      ...
      if (error.response) {
        ...
        console.error("Payload sent:", (apiPayload, null, 2));
