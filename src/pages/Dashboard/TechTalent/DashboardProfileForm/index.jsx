...
//   const steps = ["MultiStepForm1", "MultiStepForm2", "MultiStepForm3"];
//
...
//             onComplete={() => handleFormCompletion("MultiStepForm1")}
//           />
//         );
//       case "MultiStepForm2":
//         return (
...
//             formData={formData}
//             setFormData={setFormData}
//             onComplete={() => handleFormCompletion("MultiStepForm2")}
//           />
//         );
//       case "MultiStepForm3":
//         return (
...
//             formData={formData}
//             setFormData={setFormData}
//             onComplete={() => handleFormCompletion("MultiStepForm3")}
//           />
//         );
//       default:
//         return null;
...
//           {index === totalPagesCount - 1 ? "Complete Profile" : "Continue"}
//         </button>
//       </div>
//     </div>
//   );
...
function TechTalentProfileForm() {
    ...
    const handleProfileCompletion = async () => {
      // console.log(formData, 'Profile Completed');
        try {
          const loginKey = window.sessionStorage.getItem('NXGJOBHUBLOGINKEYV1') || window.sessionStorage.getItem("NXGJOBHUBLOGINKEYV1");
          if (!loginKey) {
            console.error('Authentication key not available.');
            return;
          }
