  ...
  return (
    <section className="w-full bg-white">
      <div className="w-[95%] m-auto pt-5">
        <h1 className="text-[#006A90] font-semibold text-2xl">
          Privacy Policy
        </h1>
        <article className=" text-sm md:text-xl py-5 font-medium">
          <h2 className="text-[#006A90] text-sm md:text-xl  font-bold pb-3">
            Introduction
          </h2>
          <p className="pb-3">
          ...
          <div className="pb-3">
            ...
            <p>
              ...
              for your profile, such as skills, experience, education, and
              employment history.
            </p>
            <p>
          ...
          <div className="pb-3">
            <p>
              ...
              with our platform, such as IP addresses, browser types, device
              identifiers, and access times.
            </p>
            <p>
              &#8226; Cookies: We use cookies and similar technologies to
              collect information about your preferences and usage patterns.
            </p>
            <p>
          ...
          <div className="pb-3">
            ...
            <p>
              ...
              including company details, job postings, and hiring practices.
            </p>
          </div>
          <h2 className="font-bold pb-3"> 2. How We Use Your Information</h2>
          <p className="pb-3">
          ...
          <div className="pb-3">
            <p>
              &#8226; Performance Metrics: To analyse platform performance and
              user engagement.
            </p>
            <p>
          ...
          <h2 className="font-bold pb-3">3. Sharing Your Information</h2>
          <p className="pb-3">
            We may share your information with the following parties:
          </p>
          <h2 className="font-bold text-[#006A90] pb-3">
            3.1. Employers and Agents
          </h2>
          <div className="pb-3">
            <p>
              &#8226; Job Applications: We share your profile and application
              details with employers and agents to facilitate job placements.
            </p>
            <p>
          ...
          <h2 className="font-bold pb-3"> 4. Data Security</h2>
          <p className="pb-3">
          ...
          <div className="pb-3">
            ...
            <p>
              &#8226; Access Controls: We restrict access to personal
          ...
          <h2 className="font-bold pb-3">5. Your Rights and Choices </h2>
          <p className="pb-3">
          ...
          <h2 className="font-bold text-[#006A90] pb-3">5.2. Deletion</h2>
          <div className="pb-3">
            <p>
          ...
          <h2 className="font-bold text-[#006A90] pb-3">5.3. Opt-Out</h2>
          <div className="pb-3">
            <p>
          ...
          <h2 className="font-bold pb-3">6. Third-Party Links</h2>
          <p className="pb-3">
          ...
          <h2 className="font-bold pb-3">7. Changes to This Policy</h2>
          <p className="pb-3">
          ...
          <h2 className="font-bold pb-3">8. Contact Us </h2>
          <p className="pb-3">
