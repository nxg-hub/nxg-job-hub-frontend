      ...
      <div className="salary-stats">
        ...
        <div className="statistics-container">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart
              data={salaryData}
              margin={{ top: 30, right: 25, bottom: 0, left: 10 }}
              barGap={0}>
              <XAxis
                dataKey="name"
                stroke="#000"
              ...
              <YAxis
                ...
                tick={[0, 500, 1000, 2000, 3000, 4000]}
              />
              <Bar
                type=""
                name=""
              ...
              <Bar
                ...
                name=""
                dataKey="do"
                fill="rgba(37, 150, 190, 0.4)"
              />
              <Bar type="" name="" dataKey="pd" fill="rgba(37, 150, 190, 1)" />
              <Bar type="" name="" dataKey="wd" fill="rgba(35, 56, 98, 1)" />
              <Legend
