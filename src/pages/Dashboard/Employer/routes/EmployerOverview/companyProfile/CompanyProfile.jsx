        ...
        <>
          {companyDescription ? (
            <div className="company-contents">
              <p className="company-contents-text uppercase tracking-wider !font-medium">
                {companyDescription}
              </p>
            ...
            <div className="company-contents">
              <p className="company-contents-text">
                Try <strong>Completing and Updating Your Profile</strong> to
                ensure having your company profile here.
              </p>
