...
const EmployerDashProfile = () => {
  ...
  const fetchEmployerData = useCallback(async () => {
    try {
      ...
      setVerificationStatus(employerData.user.profileVerified || false);
    } catch (error) {
  ...
  return (
    <div className="dash-profile-main-container" style={{ background: "#fff" }}>
      ...
      <div className="employer-dash-section">
        <div className="employer-dash">
          ...
          <form onSubmit={handleSave}>
            ...
            <div className="my-profile-email">
              <Inputs type="email" title="Email" value={email} disabled />
            </div>
        ...
        {updateSuccess && (
          <>
            <div className="w-[80%] absolute top-[200px] md:w-[50%] md:right-[20%] m-auto h-[100px] bg-blue-200 z-30 rounded-lg">
              <h2 className="text-center mt-[20px] font-bold md:text-3xl">
                Update Successful.
              </h2>
            </div>
            <div
        ...
        <div className="employer-dash1">
          <section>
            <div className="employ-dashBtns">
              ...
              {!isVerified && (
                <Link to="/verifiedForm" className="verifiedForm-btn">
                  Verify Account
                </Link>
              )}
            </div>
