    ...
    <div className='login-main-container'>
      <div className="form-col">
        <div className='log-bg'>
          <div style={{width:"7rem", height:"5rem", position:"absolute", margin:"8px 0 0 8px"}} className="tech-img">
        ...
        <form className='logintech' onSubmit={handleLogin}>
          ...
          <div className="log-form">
            ...
            <div className="forgot">
              <Link to="/forgotpassword" style={{color: "#A39E9E", textDecoration: "underline"}}>Forgort Password?</Link>
            </div>
            <div className="remember">
              <div className="check" style={{display:'flex', alignItems:"center"}}>
                <input type="checkbox" aria-label='checkbox' checked={check} onChange={onCheck}/>
                <label style={{ fontSize: ".7rem", fontWeight:'500', fontFamily:"Inter", margin: ".4rem" }}>
                  Keep me logged in
                </label>
              </div>
            </div>
