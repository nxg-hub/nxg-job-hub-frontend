            ...
            <form name='newsletter' method='POST' onSubmit={handleSubmit}>
              ...
              <div style={{width:'100%'}}> 
                ...
                <input 
                  ...
                  className={errors.email === "setErrors" ? 'error-input' : 'sub-input'}
                  />
              </div>
                ...
                <Dialog.Panel>
                  <Dialog.Title style={{ fontFamily: "Manrope", marginBottom: '2rem', color: '#000000', textAlign: "center" }}>
                    ...
                    <div style={{marginTop:"3rem"}}>
                      <Link
                        style={{ background: "#2596BE", padding:'10px', display:'block', color:'#ffffff', borderRadius:'0.6rem', textAlign:'center', fontSize: "1rem", fontWeight: "400"}}
                        to={"/login"}
                      >
