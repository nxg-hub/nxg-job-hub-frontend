...
const ObjectiveCard = ({ num, title, content }) => {
  return (
    <div className="bg-[#D9D9D9] w-[100%] m-auto text-justify p-5 rounded-2xl  my-2 sm:w-[80%] md:w-[300px] md:h-[500px] lg:w-[100%] hover:scale-105 transition-all duration-500  xl:h-[400px] ">
