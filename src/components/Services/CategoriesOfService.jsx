...
import { FiUser, FiTool, FiBriefcase } from "react-icons/fi";
...
const CategoriesOfService = () => {
  return (
    <section className="w-[90%] md:w-[85%] mx-auto mt-16 space-y-14">
      {/* For Talent */}
      <div>
        <AudienceHeading icon={FiUser}>For Talent</AudienceHeading>
        <motion.div
      ...
      <div>
        <AudienceHeading icon={FiTool}>For Service Provider</AudienceHeading>
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="show"
      ...
      {/* For Employer */}
      <div>
        <AudienceHeading icon={FiBriefcase}>For Employer</AudienceHeading>
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="show"
